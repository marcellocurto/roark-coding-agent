        ...
        additionalSections: [
          {
            ...
            items: [
              "The diff confirms a reusable pattern without creating actionable work. @maintainers <script>",
            ],
          },
        ],
      },
